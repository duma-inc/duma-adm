...
import { MdKeyboardArrowDown, MdDashboard, MdSchool, MdPeople, MdMenuBook, MdLibraryBooks, MdLogout, MdAssignment, MdBugReport, MdAttachMoney, MdGroups, MdFolder, MdRateReview, MdMic, MdSlowMotionVideo, MdBook, MdArticle, MdNotifications, MdSlideshow, MdSportsEsports, MdStyle, MdEmail, MdCampaign, MdTimeline, MdSettings } from 'react-icons/md';
            ...
            <Menu isLazy>
              ...
              <Portal>
                <MenuList zIndex={20} bg="#2a2a2a" borderColor="whiteAlpha.100" color="white">
                  ...
                  <MenuItem bg="transparent" _hover={{ bg: 'whiteAlpha.100' }} icon={<Icon as={MdSettings} />} onClick={() => router.push('/domains/settings')}>
                    Configurações
                  </MenuItem>
                </MenuList>
              </Portal>
